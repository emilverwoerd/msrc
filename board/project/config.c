...
void config_forze_write()
{
    ...
    config.refresh_rate_rpm = 0;
    config.refresh_rate_voltage = 0;
    config.refresh_rate_current = 0;
    config.refresh_rate_temperature = 0;
    config.refresh_rate_gps = 0;
    config.refresh_rate_consumption = 0;
    config.refresh_rate_vario = 0;
    config.refresh_rate_airspeed = 0;
    config.refresh_rate_default = 0;
    ...
    config.smartport_sensor_id = 0;
    config.smartport_data_id = 0;
    config.vario_auto_offset = VARIO_AUTO_OFFSET;
    config.xbus_clock_stretch = 0;
    config.jeti_gps_speed_units_kmh = 0;
    ...
    config.esc_hw4_current_max = ESC_HW4_CURRENT_MAX;
    config.ibus_alternative_coordinates = false;
    config.debug = MSRC_DEBUG;
    config.spare1 = 0;
    config.spare2 = 0;
    config.spare3 = 0;
